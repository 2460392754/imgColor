    ...
    methods: {
        ...
        async _imgToAscii () {
            ...
            const { filePath } = this.imgParams.before,
                { slider, action, color } = this.imgParams.after,
        ...
        // 图片缩放后大小，正常缩放比例下 分辨率是原先的20倍 (数据仅供参数!!!!)
        ...
        /**
         * 计算 修改之后的图片分辨率，正常缩放比例下 分辨率是原先的15倍
         * 
        ...
        _imgComputedResolution (scale) {
            ...
            return {
                width: parseInt(width * 15 * scale),
                height: parseInt(height * 15 * scale)
            };
        },
