<template>
	<view class="index">
		<scroll-view scroll-y class="page">
			<image src="/static/index/BasicsBg.png" class="banner"></image>
			<view class="nav-list">
				<view
		...
		<base-tabbar PageCur="index"></base-tabbar>
	</view>
</template>
